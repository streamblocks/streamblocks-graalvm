 ...
 * all CAL types that are objects are handled by the {@link #readObject} method.
 * <p>
...
public abstract class CALReadLocalVariableNode extends CALExpressionNode {

    /**
     * Returns the descriptor of the accessed local variable. The implementation of this method is
     * created by the Truffle DCAL based on the {@link NodeField} annotation on the class.
     */
