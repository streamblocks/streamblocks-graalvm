...
public class CALActor implements TruffleObject {

    public static final int INLINE_CACHE_SIZE = 2;

    private static final TruffleLogger LOG = TruffleLogger.getLogger(CALLanguage.ID, CALActor.class);
    ...
    protected CALActor(CALLanguage language, String name) {
        this.name = name;
    ...
    /**
     * {@link CALActor} instances are always visible as executable to other languages.
     */
    @SuppressWarnings("static-method")
    @ExportMessage
    ...
    static final class IsIdenticalOrUndefined {
        @Specialization
        static TriState doCALFunction(CALActor receiver, CALActor other) {
            /*
        ...
        @Fallback
        static TriState doOther(CALActor receiver, Object other) {
    ...
    @ExportMessage
    @CompilerDirectives.TruffleBoundary
    static int identityHashCode(CALActor receiver) {
    ...
    abstract static class Execute {
        ...
        @SuppressWarnings("unused")
        protected static Object doDirect(CALActor function, Object[] arguments,
        ...
        protected static Object doIndirect(CALActor function, Object[] arguments,
