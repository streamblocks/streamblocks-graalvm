...
public class CALEntityAddInputPortNode extends CALStatementNode {
    @Child private CALExpressionNode entity;
    @Child private CALExpressionNode fifo;
    private String portname;

    public CALEntityAddInputPortNode(String portname, CALExpressionNode entity, CALExpressionNode fifo) {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        entityInstance.addInputPort(portname, fifoConsumer);
    }
}
