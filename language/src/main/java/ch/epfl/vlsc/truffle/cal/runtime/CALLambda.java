...
public class CALLambda extends CALValue {
    ...
    public CALLambda(CALRootNode body, MaterializedFrame frame) {
        this.body = body;
    ...
    /**
     * {@link CALLambda} instances are always visible as executable to other languages.
     */
    ...
    static final class IsIdenticalOrUndefined {
        ...
        @Fallback
        static TriState doOther(CALLambda receiver, Object other) {
    ...
    @ExportMessage
    @TruffleBoundary
    static int identityHashCode(CALLambda receiver) {
    ...
    abstract static class Execute {
        ...
        @SuppressWarnings("unused")
        protected static Object doDirect(CALLambda function, Object[] arguments,
        ...
        protected static Object doIndirect(CALLambda function, Object[] arguments,
