...
@NodeField(name = "nameNode", type = CALExpressionNode.class)
@NodeField(name = "declaration", type = boolean.class)
public abstract class CALWriteFrameSlotNode extends Node implements FrameSlotNode {
	...
	//public abstract voiFd executeWrite(VirtualFrame frame, Object value);
     ...
     */
    protected abstract CALExpressionNode getNameNode();
    ...
    protected boolean isBooleanOrIllegal(Frame frame) {
        final FrameSlotKind kind = frame.getFrameDescriptor().getFrameSlotKind(getSlot());
    ...
    public Object getNodeObject() {
    	CALExpressionNode nameNode = getNameNode();
