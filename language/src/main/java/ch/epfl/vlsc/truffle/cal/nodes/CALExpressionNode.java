...
/**
 * Base class for all CAL nodes that produce a value and therefore benefit from type specialization.
 * The annotation {@link TypeSystemReference} specifies the CAL types. Specifying it here defines the
